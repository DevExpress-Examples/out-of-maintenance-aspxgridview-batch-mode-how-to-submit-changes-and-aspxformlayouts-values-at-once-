    ...
    <form id="form1" runat="server">
        <div style="display: inline-block">
            ...
            <div style="text-align: right; padding: 2px">
                <dx:ASPxButton ID="submitButton" ClientInstanceName="submitButton" runat="server" RenderMode="Link" 
                    AutoPostBack="false" ClientEnabled="false">
                    <ClientSideEvents Click="onSubmit" />
                    <Image IconID="actions_apply_32x32office2013"></Image>
                </dx:ASPxButton>
                <dx:ASPxButton ID="cancelButton" ClientInstanceName="cancelButton" runat="server" RenderMode="Link" 
                    AutoPostBack="false" ClientEnabled="false">
